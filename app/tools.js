...
export const TOOLS = [
  ...
  },
  {
    ...
    icon: 'layout-grid',
    category: 'Design',
    description: "Stick images together into one sheet — spritesheets, flipbook frames or a plain grid.",
    keywords: ['image stitcher', 'spritesheet', 'sprite sheet maker', 'sprite atlas', 'flipnote', 'contact sheet', 'combine images', 'merge images', 'photo grid', 'tile images', 'game dev'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'stamp',
    category: 'Design',
    description: "Stamp your name, a logo or a “DRAFT” across your pictures, one or a hundred at a time.",
    keywords: ['watermark', 'watermarker', 'add watermark', 'logo overlay', 'copyright', 'batch watermark', 'tiled watermark', 'draft stamp', 'photo credit'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'monitor',
    category: 'Files',
    description: "Record your screen, a window or a tab, with its sound and your microphone.",
    keywords: ['screen recorder', 'screen capture', 'record screen', 'screencast', 'record tab', 'record window', 'webm recorder', 'demo video'],
    madeWith:
      "The browser's own getDisplayMedia picks what to share and MediaRecorder writes the video, with the microphone (getUserMedia) mixed in beside the screen's sound as a second track. Chunks are collected in memory and stitched into a WebM (MP4 in Safari) when you stop. Nothing is uploaded: there is no server to upload to.",
    credits: [],
  },
  {
    ...
    icon: 'key',
    category: 'Dev',
    description: "Decode (or write) Caesar, Vigenère, Atbash, rail fence, Morse and friends — or let it crack the message for you.",
    keywords: ['cipher', 'decoder', 'decrypt', 'caesar cipher', 'rot13', 'vigenere', 'atbash', 'rail fence', 'morse code', 'a1z26', 'cryptogram', 'code breaker', 'puzzle'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'music',
    category: 'Files',
    description: "Pull the sound out of a video and save it as MP3, M4A, WAV and more.",
    keywords: ['audio extractor', 'extract audio', 'video to mp3', 'rip audio', 'get sound from video', 'mp4 to mp3', 'soundtrack', 'audio from video'],
    madeWith:
    ...
    credits: [{ name: 'ffmpeg.wasm', author: 'Jerome Wu', license: 'MIT (FFmpeg: LGPL/GPL)', url: 'https://github.com/ffmpegwasm/ffmpeg.wasm' }],
  },
  {
    label: 'Video Muter',
    route: 'video-muter',
    icon: 'volume-x',
    category: 'Files',
    description: "Take the sound off a video and keep the picture exactly as it was.",
    keywords: ['video muter', 'mute video', 'remove audio', 'silence video', 'strip sound', 'no sound', 'remove sound from video'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'scissors',
    category: 'Files',
    description: "Cut a piece out of a video or a song, with a preview of exactly what you're keeping.",
    keywords: ['trimmer', 'trim video', 'cut video', 'trim audio', 'cut mp3', 'clip', 'crop video length', 'shorten video', 'ringtone'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'shield',
    category: 'Files',
    description: "See what's hidden inside your photos and media — camera, software, even where you stood — and strip it out.",
    keywords: ['metadata', 'exif', 'exif remover', 'strip metadata', 'gps', 'location', 'privacy', 'id3', 'tags', 'photo metadata', 'scrub'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'captions',
    category: 'Files',
    description: "Writes the subtitles for a video or a recording, with timings, without uploading a thing.",
    keywords: ['subtitles', 'captions', 'transcribe', 'transcription', 'speech to text', 'srt', 'vtt', 'whisper', 'auto caption', 'dictation', 'video to text'],
    madeWith:
    ...
    credits: [{ name: 'transformers.js', author: 'Hugging Face', license: 'Apache-2.0', url: 'https://github.com/huggingface/transformers.js' }, { name: 'ffmpeg.wasm', author: 'Jerome Wu', license: 'MIT (FFmpeg: LGPL/GPL)', url: 'https://github.com/ffmpegwasm/ffmpeg.wasm' }],
  },
  {
    ...
    icon: 'volume-2',
    category: 'Files',
    description: "Make a pile of clips all sit at the same volume, at the levels streaming services expect.",
    keywords: ['audio normalizer', 'normalise audio', 'loudness', 'lufs', 'ebu r128', 'volume', 'level audio', 'peak normalize', 'podcast loudness', 'quiet audio'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'spell-check',
    category: 'Text',
    description: "Catches the mistakes and tells you why each one is a mistake, as you type.",
    keywords: ['grammar', 'grammar checker', 'spelling', 'proofread', 'punctuation', 'style', 'passive voice', 'readability', 'flesch', 'writing', 'editor'],
    madeWith:
      "Rules, written by hand: common misspellings, the words people mix up (“could of”, “your welcome”, “fewer” and “less”), a/an, doubled words, spacing and punctuation, capitals, padding and passive voice — each with a plain-English note on why. Reading ease is the Flesch formula with a syllable counter. A small instruction model (flan-t5, via transformers.js) is there for a second opinion when you ask for it, and runs on your device like everything else.",
    credits: [{ name: 'transformers.js', author: 'Hugging Face', license: 'Apache-2.0', url: 'https://github.com/huggingface/transformers.js' }],
  },
  {
    label: 'Paraphraser',
    route: 'paraphraser',
  ...
  },
  {
    ...
    icon: 'book-open',
    category: 'Text',
    description: "Words to braille and back, as Unicode cells you can copy anywhere.",
    keywords: ['braille', 'text to braille', 'braille translator', 'unicode braille', 'blind', 'accessibility', 'grade 1', 'dots'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'languages',
    category: 'Text',
    description: "English spelling turned into IPA, in American or British English.",
    keywords: ['ipa', 'phonetic', 'phonetics', 'pronunciation', 'transcription', 'international phonetic alphabet', 'conlang', 'accent', 'singing'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'audio-lines',
    category: 'Text',
    description: "Words to Morse code and back, played out loud at the speed you pick.",
    keywords: ['morse', 'morse code', 'text to morse', 'morse translator', 'cw', 'ham radio', 'dits', 'dahs', 'sos'],
    madeWith:
  ...
  },
  {
    ...
    icon: 'package',
    category: 'Files',
    description: "Look inside a ZIP, 7z, RAR, TAR or ISO: see what's there, preview it, pull out what you need.",
    keywords: ['archive', 'unzip', 'extract', 'zip opener', '7z', 'rar', 'tar', 'gz', 'iso', 'unrar', 'open archive', 'decompress', 'password'],
    madeWith:
    ...
    credits: [{ name: '7-Zip (7z-wasm)', author: 'Igor Pavlov / use-strict', license: 'LGPL-2.1', url: 'https://github.com/use-strict/7z-wasm' }, { name: 'fflate', author: '101arrowz', license: 'MIT', url: 'https://github.com/101arrowz/fflate' }],
  },
  {
    label: 'Chess',
    route: 'chess',
