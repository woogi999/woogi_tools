...
export default class FileArchiverPage extends Component {
  ...
  get pipWarning() {
    return 'Close the File Archiver? The work in progress will be cancelled.';
  }
  ...
  <template>
    <ToolPage
      ...
      @subtitle="Pack files into a zip or 7z, unpack one (rar included), or run a single file through gzip, deflate, brotli or zstd. Right here in your browser."
    >
